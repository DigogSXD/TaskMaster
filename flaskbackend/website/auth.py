from flask import Blueprint, render_template, request,flash,redirect,url_for,login_required,current_user
...
def home():
    ...
    projetos = Project.query.filter_by(user_id=current_user.id_user).all()
